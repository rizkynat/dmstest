...
<div class="flex items-center min-h-screen p-6 bg-gray-50 ">
  <div class="flex-1 h-full p-10 max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl">
    @if(session('success'))
    <div id="alert-success" class="z-[1000] text-red-700 bg-red-50 flex left-1/2 top-1/8 transform -translate-x-1/2 -translate-y-1/2 fixed p-4 mr-4 mt-4 mb-4 text-sm rounded-lg" role="alert">
