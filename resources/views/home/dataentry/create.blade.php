...
<body>
                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="mb-4 grid gap-6 w-full">
                        <div class="min-w-0 p-4 bg-white rounded-lg shadow-md">
                            ...
                            @endif
                            <form id="loanForm" action="{{ route('storeLoan') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="nama-nasabah" name="nama_nasabah" value="{{ request('nama_nasabah', old('nama_nasabah')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Nama" >
                                    </div>

                                    <div class="mb-4">
                                        <label for="nik" class="block text-sm font-medium text-gray-700 mb-2">NIK <span class="text-red-600">*</span></label>
                                        <input type="number" id="nik" name="nik" value="{{ request('nik', old('nik')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Kode Pos" >
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="tempat-lahir" name="tempat_lahir" value="{{ request('tempat_lahir', old('tempat_lahir')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Tempat Lahir" >
                                    </div>
                                    <div class="mb-4">
                                        <label for="tgl-lahir" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Lahir <span class="text-red-600">*</span></label>
                                        <input type="date" id="tgl-lahir" name="tgl_lahir" value="{{ request('tgl_lahir', old('tgl_lahir')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Tanggal Lahir" >
                                    </div>
                                    <div class="mb-4">
                                        <label for="jenis-kelamin" class="block text-sm font-medium mb-2">Jenis kelamin <span class="text-red-600">*</span></label>
                                        <select id="jenis-kelamin" name="jenis_kelamin" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" >
                                            <option>Pilih</option>
                                            <option value="pria" {{ request('jenis_kelamin', old('jenis_kelamin')) == 'pria' ? 'selected' : '' }}>Pria</option>
                                            <option value="wanita" {{ request('jenis_kelamin', old('jenis_kelamin')) == 'wanita' ? 'selected' : '' }}>Wanita</option>
                                        </select>
                                    </div>

                                    <div class="mb-4">
                                        <label for="alamat" class="block text-sm font-medium text-gray-700 mb-2">Alamat Lengkap <span class="text-red-600">*</span></label>
                                        <textarea id="alamat" name="alamat" value="{{ request('alamat', old('alamat')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Alamat Lengkap" required>
                                    </textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="kelurahan" class="block text-sm font-medium text-gray-700 mb-2">Kelurahan <span class="text-red-600">*</span></label>
                                        <input type="text" id="kelurahan" name="kelurahan" value="{{ request('kelurahan', old('kelurahan')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Kelurahan" >
                                    </div>


                                    <div class="mb-4">
                                        <label for="kecamatan" class="block text-sm font-medium text-gray-700 mb-2">Kecamatan <span class="text-red-600">*</span></label>
                                        <input type="text" id="kecamatan" name="kecamatan" value="{{ request('kecamatan', old('kecamatan')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Kecamatan" >
                                    </div>

                                    <div class="mb-4">
                                        <label for="kabupaten" class="block text-sm font-medium text-gray-700 mb-2">Kabupaten <span class="text-red-600">*</span></label>
                                        <input type="text" id="kabupaten" name="kabupaten" value="{{ request('kabupaten', old('kabupaten')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Kabupaten" >
                                    </div>
                                    <div class="mb-4">
                                        <label for="provinsi" class="block text-sm font-medium text-gray-700 mb-2">Provinsi <span class="text-red-600">*</span></label>
                                        <input type="text" id="provinsi" name="provinsi" value="{{ request('provinsi', old('provinsi')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Provinsi" >
                                    </div>
                                    <div class="mb-4">
                                        <label for="kode-pos" class="block text-sm font-medium text-gray-700 mb-2">Kode Pos <span class="text-red-600">*</span></label>
                                        <input type="number" id="kode-pos" name="kode_pos" value="{{ request('kode_pos', old('kode_pos')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Kode Pos" >
                                    </div>
                                    <div class="mb-4">
                                        <label for="no-rek" class="block text-sm font-medium text-gray-700 mb-2">No. Rek tabungan <span class="text-red-600">*</span></label>
                                        <input type="number" id="no-rek" name="no_rek" value="{{ request('no_rek', old('no_rek')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan No Rekening" >
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input id="no-hp" type="number" name="no_hp" value="{{ request('no_hp', old('no_hp')) }}" class="block pl-12 w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" placeholder="Masukan Nomor Handphone" >
                                        </div>
                                        <!-- <div class="relative">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="email" id="email" name="email" value="{{ request('email', old('email')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Alamat Email">
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <div class="flex">
                                            ...
                                            <button id="download-ktp" value="{{ request('ktp', old('ktp')) }}" class="bg-primary text-white ml-4 rounded-md px-4 py-2 hover:bg-green-400">Download</button>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input id="jml-penghasilan" name="jml_penghasilan" type="number" value="{{ request('jml_penghasilan', old('jml_penghasilan')) }}" class="pl-10 w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <span class="absolute inset-y-0 left-0 px-3 flex items-center text-gray-500">Rp</span>
                                                <input id="jml-penghasilan-other" name="jml_penghasilan_other" value="{{ request('jml_penghasilan_other', old('jml_penghasilan_other')) }}" type="number" class="pl-10 w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <span class="absolute inset-y-0 left-0 px-3 flex items-center text-gray-500">Rp</span>
                                                <input id="jml-permohonan" name="jml_permohonan" value="{{ request('jml_permohonan', old('jml_permohonan')) }}" type="number" class="pl-10 w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <input id="j-waktu-permohonan" name="j_waktu_permohonan" value="{{ request('j_waktu_permohonan', old('j_waktu_permohonan')) }}" type="number" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="flex">
                                                <div class="relative w-full">
                                                    <span class="absolute inset-y-0 left-0 px-3 flex items-center text-gray-500">Rp</span>
                                                    <input id="max-pembiayaan" name="max_pembiayaan" value="{{ request('max_pembiayaan', old('max_pembiayaan')) }}" type="number" class="block pl-10 w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                                </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="tujuan-pembiayaan" name="tujuan_pembiayaan" value="{{ request('tujuan_pembiayaan', old('tujuan_pembiayaan')) }}" class="block w-full bg-white p-2.5 border border-gray-300 rounded-lg mt-1 text-sm focus:border-primary focus:outline-none focus:shadow-outline-primary form-input" placeholder="Masukan Tujuan Pembiyaan" >
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select id="status-kawin" name="status_kawin" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                                ...
                                                <option value="menikah" {{ request('status_kawin', old('status_kawin')) == 'menikah' ? 'selected' : '' }}>Menikah</option>
                                                <option value="belum menikah" {{ request('status_kawin', old('status_kawin')) == 'belum menikah' ? 'selected' : '' }}>Belum Menikah</option>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="flex">
                                                ...
                                                <button id="download-npwp" class="bg-primary text-white ml-4 rounded-md px-4 py-2 hover:bg-green-400">Download</button>
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="flex">
                                                ...
                                                <button id="download-slip-gaji" class="bg-primary text-white ml-4 rounded-md px-4 py-2 hover:bg-green-400">Download</button>
                                            </div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input id="nama-instansi" name="nama_instansi" value="{{ request('nama_instansi', old('nama_instansi')) }}" type="text" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" placeholder="Masukan Nama Instansi" >
                                        </div>

                                        <div>
                                            <label for="no-instansi" class="block text-sm font-medium text-gray-700 mb-2">No Instansi <span class="text-red-600">*</span></label>
                                            <input id="no-instansi" name="no_instansi" value="{{ request('no_instansi', old('no_instansi')) }}" type="text" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" placeholder="Masukan No Instansi" >
                                        </div>

                                        <div>
                                            <label for="jabatan" class="block text-sm font-medium text-gray-700 mb-2">Golongan/Jabatan <span class="text-red-600">*</span></label>
                                            <input id="jabatan" name="jabatan" value="{{ request('jabatan', old('jabatan')) }}" type="text" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" placeholder="Masukan Golongan/Jabatan" >
                                        </div>
                                        <div>
                                            <label for="nip" class="block text-sm font-medium text-gray-700 mb-2">NIP <span class="text-red-600">*</span></label>
                                            <input id="nip" name="nip" value="{{ request('nip', old('nip')) }}" type="number" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" placeholder="Masukan NIP" >
                                        </div>

                                        <div>
                                            <label for="masa-kerja" class="block text-sm font-medium text-gray-700 mb-2">Masa Kerja <span class="text-red-600">*</span></label>
                                            <input id="masa-kerja" name="masa_kerja" value="{{ request('masa_kerja', old('masa_kerja')) }}" type="date" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                        </div>
                                        <div>
                                            <label for="nama-atasan" class="block text-sm font-medium text-gray-700 mb-2">Nama Atasan <span class="text-red-600">*</span></label>
                                            <input id="nama-atasan" name="nama_atasan" value="{{ request('nama_atasan', old('nama_atasan')) }}" type="text" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" placeholder="Masukan Nama Atasan" >
                                        </div>
                                        <div>
                                            ...
                                            <input id="alamat-kantor" name="alamat_kantor" value="{{ request('alamat_kantor', old('alamat_kantor')) }}" type="text" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" placeholder="Masukan Alamat Kantor" >
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="w-full bg-white rounded-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border px-4 py-2"><button id="download-karpeg" class="bg-primary text-white px-4 py-2 rounded-md">Download</button></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="border px-4 py-2"><button id="download-taspen" class="bg-primary text-white px-4 py-2 rounded-md">Download</button></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="border px-4 py-2"><button id="download-sk80" class="bg-primary text-white px-4 py-2 rounded-md">Download</button></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="border px-4 py-2"><button id="download-sk100" class="bg-primary text-white px-4 py-2 rounded-md">Download</button></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="border px-4 py-2"><button id="download-sk-terakhir" class="bg-primary text-white px-4 py-2 rounded-md">Download</button></td>
                                            </tr>
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <span class="absolute inset-y-0 left-0 px-3 flex items-center text-gray-500">Rp</span>
                                                <input id="total-angsuran" name="total_angsuran" value="{{ request('total_angsuran', old('total_angsuran')) }}" type="number" class="pl-10 w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                            </div>
                                        </div class="mb-4">
                                        <div class="mb-4">
                                            ...
                                            <div class="relative">
                                                <input id="j-waktu-biaya" name="j_waktu_biaya" value="{{ request('j_waktu_biaya', old('j_waktu_biaya')) }}" type="number" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                                <span class="absolute inset-y-0 right-0 px-4 flex items-center rounded-lg text-white bg-green-400">Bulan</span>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            ...
                                            <select id="cabang" name="cabang" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                                <option>Pilih...</option>
                                                <option value="jakarta" {{ request('cabang', old('cabang')) == 'jakarta' ? 'selected' : '' }}>Jakarta</option>
                                                <option value="riau" {{ request('cabang', old('cabang')) == 'riau' ? 'selected' : '' }}>Riau</option>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select id="capem" name="capem" class="w-full bg-white border border-gray-300 rounded-lg p-2.5 focus:border-primary focus:outline-none" >
                                                <option>Pilih...</option>
                                                <option value="jakarta barat" {{ request('capem', old('capem')) == 'jakarta barat' ? 'selected' : '' }}>Jakarta Barat</option>
                                                <option value="jakarta selatan" {{ request('capem', old('capem')) == 'jakarta selatan' ? 'selected' : '' }}>Jakarta Selatan</option>
                                                <option value="kampar" {{ request('capem', old('capem')) == 'kampar' ? 'selected' : '' }}>Kampar</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="mt-8 flex gap-4">
                                        <button id="resetFormButton" class="w-full bg-red-600 t hover:bg-red-700 text-white px-4 py-2 rounded-md">Reset</button>
    ...
    <script type="text/javascript">
        ...
        resetButton.addEventListener('click', () => {
            // Clear all input, select, and textarea fields in the form
